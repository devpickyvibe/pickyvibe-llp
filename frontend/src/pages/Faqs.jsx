    ...
    <>
      ...
      <div class="faq-cta-main-wrapper-bg rts-section-gap2">
                  ...
                  <div class="accordion" id="accordionExamples">
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingOne">
                        ...
                        >
                          What are your core services as a UX design and
                          branding firm?
                        </button>
                      </h2>
                      <div
                      ...
                      >
                        <div class="accordion-body">
                          <p class="disc">
                            However, our passion for branding and the demand
                            from our clients led us to expand our offering to
                            provide full-service brand design practice and web
                            design and development of marketing websites.
                          </p>
                          <p class="disc">
                            Today, our projects encompass a wide range, from
                            building new products and defining brands to
                            revitalizing existing mobile apps, websites, and
                            enterprise software. We specialize in crafting
                            digital products that wholeheartedly embody the
                            brand's personality and deliver delightful
        ...
        <div class="shape-area">
          <img src="assets/images/faq/shape/01.png" alt="" class="one" />
          <img src="assets/images/faq/shape/02.png" alt="" class="two" />
          <img src="assets/images/faq/shape/03.png" alt="" class="three" />
          <img src="assets/images/faq/shape/04.png" alt="" class="four" />
        </div>
      </div>
    </>
  );
