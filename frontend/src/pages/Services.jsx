          ...
          <div class="row g-48 mt--40">
            <div class="col-lg-4 col-sm-6">
              <div class="service-page-service-style">
                ...
                <a href="#" class="learn-more-btn-underline">
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="service-page-service-style">
                ...
                <p class="disc">
                  Optimizing your website for each of the main components to put
                  a good and fit in house strategy in place.
                </p>
                <a href="#" class="learn-more-btn-underline">
                  Learn more <i class="fa-light fa-arrow-right"></i>
                </a>
            ...
            <div class="col-lg-5 col-md-6 offset-lg-1">
              <div class="portfolio-content-wrapper-list">
                ...
                <p class="disc">
                  ...
                  methodology to deliver compelling corporate brands for
